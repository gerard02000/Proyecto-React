...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen grid grid-cols-1 xl:grid-cols-8 gap-8 xl:gap-0 items-center justify-center">
      {/* Information */}
      <div className="md:col-span-5 p-8 xl:p-16">
        <div className="flex flex-col gap-8 items-center md:items-start">
          <h1 className="text-5xl xl:text-7xl font-bold xl:leading-[7.5rem] text-center md:text-left">
            Welcome to CurtainCrafters
          </h1>
          <p className="text-gray-500 text-2xl leading-[2.5rem] text-center md:text-left">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4">
            <button onClick={handleContactButtonClick} className="w-full xl:w-auto bg-primary text-white py-2 px-8 rounded-xl text-xl transition duration-300 transform hover:scale-105 focus:outline-none">
              Contact Us
            </button>
            <button className="w-full xl:w-auto flex items-center justify-start text-left gap-4 py-2 px-8 rounded-xl text-xl transition duration-300 transform hover:scale-105 focus:outline-none">
